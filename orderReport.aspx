<%@ Page Language="C#" AutoEventWireup="true" CodeFile="orderReport.aspx.cs" Inherits="orderReport" %>
...
<body>
    ...
    <div>
        <asp:Label ID="Label1" runat="server" Text="输入订单编号："></asp:Label>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="400px" Width="400px">
            <LocalReport ReportPath="ReportOrder.rdlc">
                <DataSources>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="GetData" TypeName="DataSet3TableAdapters.DataTable1TableAdapter">
            <SelectParameters>
