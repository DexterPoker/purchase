<%@ Page Language="C#" AutoEventWireup="true" CodeFile="require.aspx.cs" Inherits="require" %>
	...
	<body><form id="form1" runat="server"><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li>
					...
					<ul>
						...
						<li><a href="require.aspx" class="current">需求信息维护</a></li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT po_header_id, po_number, po_type, vender_code, status FROM PO_HEADERS_ALL WHERE (po_type = '&#37319;&#36141;&#35745;&#21010;')">
            </asp:SqlDataSource>
            ...
            <p></p>
            <asp:Button ID="btnheadadd" runat="server" Text="添加需求表头" OnClick="btnheadadd_Click" />
            <asp:Button ID="btnheadupdate" runat="server" Text="修改需求表头" OnClick="btnheadupdate_Click" />
            <asp:Button ID="btnlineadd" runat="server" Text="添加需求具体行" OnClick="btnlineadd_Click" />
            <asp:Button ID="btnlineupdate" runat="server" Text="&#20462;&#25913;&#38656;&#27714;&#20855;&#20307;&#34892;" OnClick="btnlineupdate_Click" />
            <asp:Button ID="btnlinedelete" runat="server" Text="删除需求具体行" OnClick="btnlinedelete_Click" />
            <asp:Button ID="btnshowhead" runat="server" Text="&#26174;&#31034;&#38656;&#27714;&#34920;&#22836;" OnClick="btnshowhead_Click" />
            <asp:Button ID="btnshowlines" runat="server" Text="显示需求具体行" OnClick="btnshowlines_Click" />
            <asp:Button ID="btnbaobiao" runat="server" Text="生成需求报表" OnClick="btnbaobiao_Click" />
            <asp:GridView ID="GridView3" runat="server">
            </asp:GridView>
            <p>
                <asp:TextBox ID="txbselect" runat="server"></asp:TextBox>
                <asp:Button ID="btnselecthead" runat="server" Text="查询需求表头" OnClick="btnselecthead_Click" />
                <asp:Button ID="btnselectline" runat="server" Text="查询需求具体行" OnClick="btnselectline_Click" />
            </p>
            <asp:Panel ID="Panel1" runat="server" Width="400" Height="250">
                ...
                <p>
                    ...
                    <asp:TextBox ID="txbtype" runat="server" Enabled="False" ReadOnly="True">plan</asp:TextBox></label>
                </p>
                <p>
                    <label>&#20379;&#24212;&#21830;&#21495;&#65306;&nbsp; &nbsp;
